...
function st_create_kb_post_type() {
	...
	$labels = array(
		'name'                => _x( 'Knowledge Base', 'Post Type General Name', 'framework' ),
		'singular_name'       => _x( 'Knowledge Base', 'Post Type Singular Name', 'framework' ),
...
function st_create_kb_category_taxonomy()  {
	$labels = array(
		'name'                       => _x( 'Article Categories', 'Taxonomy General Name', 'framework' ),
		'singular_name'              => _x( 'Article Category', 'Taxonomy Singular Name', 'framework' ),
