...
echo '<h3><span class="count">'. $tax_term->count .' Articles</span><a href="' . esc_attr(get_term_link($tax_term, 'st_kb_category')) . '" title="' . sprintf( __( 'View all posts in %s', 'framework' ), $tax_term->name ) . '" ' . '>' . $tax_term->name.' <span>&rarr;</span></a></h3>';
