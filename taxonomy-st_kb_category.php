...
echo '<h3><span class="count">'. $st_sub_category->count . ' Articles</span><a href="' . get_term_link($st_sub_category->slug, 'st_kb_category') . '" title="' . sprintf( __( 'View all posts in %s', 'framework' ), $st_sub_category->name ) . '" ' . '>' . $st_sub_category->name.' <span>&rarr;</span></a></h3>';  
